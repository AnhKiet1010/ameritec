...
function AdminUpdateProfilePopup({ userData, onClose, setRefresh, refresh, id }) {
                                            ...
                                            <div className="-mx-3 md:flex mb-1">
                                                ...
                                                <div className="md:w-1/2 px-3 mb-3 md:mb-0 flex justify-start items-end">
                                                    <Label check className="mb-5">
                                                        <Input type="checkbox" checked={values.is_partner} className="text-purple-600 border border-gray-700 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple" onChange={() => setFieldValue('is_partner', !values.is_partner)} />
                                                        <span className="ml-2 mb-0 text-sm text-gray-700">Cộng Tác Viên</span>
                                                    </Label>
                                                </div>
                                            </div>
                                            <div className="-mx-3 md:flex">
