...
function UpdateProfilePopup({ userData, onClose, setChange, setUserData }) {
    ...
    const validationSchema = Yup.object().shape({
        ...
        bank: userData.account_type === 'vi' ? Yup.string().required(t('Vui lòng không để trống')) : Yup.string().nullable(),
        bank_account: userData.account_type === 'vi' ? Yup.string().required(t('Vui lòng không để trống')) : Yup.string().nullable(),
        ...
        bank_name: userData.account_type === 'vi' ? Yup.string().required(t('Vui lòng không để trống')) : Yup.string().nullable(),
        password: Yup.string().required(t('Vui lòng không để trống')),
        request_commission: userData.account_type === 'en' ? Yup.string().required("Please input Froms of receiving commissions") : Yup.string().nullable(),
    });
                ...
                return (
                    <div className="fixed z-10 inset-0 overflow-y-auto">
                        ...
                        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            >
                                <Form className="bg-white px-4 pt-5 sm:pt-6 overflow-y-auto" style={{ maxHeight: "80vh" }}>
                                    <div className="sm:flex sm:items-start">
                                        <div className="bg-white px-8 pt-6 flex flex-col my-2">
                                            <div className="-mx-3 md:flex">
                                                <div className={`${userData.account_type === 'vi' ? 'md:w-1/2' : 'w-full'} px-3`}>
                                                    <FastField
                                            ...
                                            <div className={`-mx-3 ${userData.account_type === 'vi' && 'md:flex'}`}>
                                                <div className={`${userData.account_type === 'vi' ? 'md:w-1/2' : 'w-full'} px-3`}>
                                                    <FastField
                                                        component={InputField}
                                                        name="newPassword"
                                                ...
                                                <div className={`${userData.account_type === 'vi' ? 'md:w-1/2' : 'w-full'} px-3 mb-3 md:mb-0`}>
                                                    <FastField
                                                        component={InputField}
                                            ...
                                            </div>
                                            {
                                                ...
                                                <>
                                                    ...
                                                    <div onClick={handleDeleteImage} className="w-full border-none focus:outline-none bg-red-600 text-white rounded-lg my-4 px-4 py-2 mx-auto text-sm text-center font-semibold">{t('xóa ảnh')}</div>
                                                </>
                                            }
                                            {
