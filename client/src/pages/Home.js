        ...
        <div>
                                ...
                                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul className="navbar-nav mr-auto">
                                        <li className="nav-item dropdown animate__animated animate__fadeIn delay-1">
                                            <a className="nav-link dropdown-toggle" href="/maintain" id="navbarDropdown" role="button" data-toggle="dropdown">
                                                Giới Thiệu
                                            </a>
                                            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a className="dropdown-item" href="#">Giới Thiệu Về Công Ty CP Ameritec</a>
                                            </div>
                                        </li>
                                        ...
                                        <li className="nav-item animate__animated animate__fadeIn delay-4">
                                            <a className="nav-link" href="/maintain">Giải Pháp</a>
                                        </li>
                                        <li className="nav-item animate__animated animate__fadeIn delay-5">
                                            <a className="nav-link" href="/maintain">Tài Liệu</a>
                                        </li>
                                    </ul>
                                    <div className="btn-menu my-2 my-lg-0 animate__animated animate__fadeIn delay-6">
                                        ...
                                        <a href="/referral/AMERITECAIPS1109/0" className="ml-2 btn btn-login bg-red-500">Đăng Ký</a>
                                    </div>
                                </div>
                            </nav>
                            <div className="top" />
                        ...
                        <div className="swiper-slide">
                            <div className="home-banner-text">
                                <h3 className="home-banner-title animate__animated animate__fadeIn delay-4">
                                    ỨNG DỤNG BẢO MẬT DI ĐỘNG<br />
                                    HÀNG ĐẦU
                                </h3>
                                <span className="d-block animate__animated animate__fadeIn delay-5">Ứng dụng ngăn chặn tin tặc xâm nhập thiết bị di động đầu tiên trên thế giới giải pháp bảo vệ toàn diện cho các thiết bị IOS &amp;
                                    Android</span>
                                <a href="/login" className="btn btn-register animate__animated animate__fadeIn animate__infinite delay-6">MUA GÓI BẢO MẬT</a>
                            </div>
                        </div>
                    </div>
               ...
               c15.3,22.7,51,22.7,53,23v28.1H0V80z" />
                ...
                <section className="strength">
                    <div className="section-heading2">
                        <div>ỨNG DỤNG</div>
                        <img src={LOGO_PNG} alt width="190px" style={{ marginTop: '-20px' }} />
                    </div>
                            ...
                            <div className="col-md-6 description">
                                <div className="desc-text">
                                    ...
                                    <div className="under-banner-text">
                                        <p>
                                            Ứng dụng ngăn chặn tin tác xâm nhập thiết bị di động đầu tiên trên thế giới,
                                            giải pháp bảo vệ toàn diện cho các thiết bị Android & IOS
                                        </p>
                                    </div>
                                    <a href="/login" className="btn btn-register animate__animated animate__headShake animate__infinite lg-center"> MUA GÓI BẢO MẬT </a>
                                </div>
                                <iframe style={{ borderRadius: 20, marginTop: 40 }} className="iframe-lg" width="100%" height="350px" src="https://www.youtube.com/embed/JhGCnn5qkdI" frameBorder={0} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen> </iframe>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-lg-6 col-md-6 col-xs-12 strength-item">
                                <div className="strength-item">
                                    <div className="content">
                                        <div className="strength-item-content">
                                            <p>
                                                Phát hiện 100% những mối đe dọa tấn công.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="icon-strength-item">
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 strength-item">
                                <div className="strength-item">
                                    <div className="content">
                                        <div className="strength-item-content">
                                            <p>
                                                Giúp người dùng kịp thời ngăn chặn sự tấn công, xâm nhập của tin tặc.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="icon-strength-item">
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 strength-item">
                                <div className="strength-item">
                                    <div className="content">
                                        <div className="strength-item-content">
                                            <p>
                                                Lưu lại lịch sử các mối đe dọa tấn công (ngày, giờ, thông tin chi tiết, địa điểm bị tấn công…).
                                            </p>
                                        </div>
                                    </div>
                                    <div className="icon-strength-item">
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 strength-item">
                                <div className="strength-item">
                                    <div className="content">
                                        <div className="strength-item-content">
                                            <p>
                                                Đưa ra cảnh bảo kèm theo hướng dẫn xử lý đối với từng trường hợp cụ thể.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="icon-strength-item">
                            ...
                            <div className="col-lg-6 col-md-6 col-xs-12 strength-item">
                                <div className="strength-item">
                                    <div className="content">
                                        <div className="strength-item-content">
                                            <p>
                                                Khu vực nguy hiểm (Danger Zone): Bản đồ những điểm truy cập wifi đã từng bị tấn công trong 30 ngày gần nhất.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="icon-strength-item">
                            ...
                            <div className="col-lg-6 col-md-6 col-xs-12 strength-item">
                                <div className="strength-item">
                                    <div className="content">
                                        <div className="strength-item-content">
                                            <p>
                                                Tính năng phân tích website: cho phép kiểm tra một đường dẫn website có an toàn hay không trước khi người dùng bấm vào truy cập.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="icon-strength-item">
                    ...
                    <h3>ỨNG DỤNG ĐƯỢC PHÁT TRIỂN BỞI <img src={ZIM_LOGO} alt="ZIMPERIUM" width="300px" style={{ margin: '30px auto' }} /></h3>
                    ...
                    <p className="max-w-40">Nền tảng của chúng tôi bảo vệ doanh nghiệp của bạn bằng cách cung cấp một lớp bảo mật di động hoàn chỉnh</p>
                    </div>
                    <div className="package-item-contain">
                    <div className="package-item-item">
                    <div className="image-contain">
                    <img src={personPackage} className="private-package" alt="GÓI CÁ NHÂN" />
                    </div>
                    ...
                    <a href="/login" className="btn btn-register" style={{ margin: 'auto' }}>Mua ngay</a>
                    </div>
                    </div>
                    <div className="package-item-item">
                    <div className="image-contain">
                    <img src={startupPackage} className="4-package" alt="GÓI KHỞI NGHIỆP" />
                    </div>
                    <div className="package-item-price-detail">
                    <h5 className="pack-title">GÓI KHỞI NGHIỆP</h5>
                    ...
                    <div className="package-item-item">
                    <div className="image-contain">
                    <img src={bussinessPackage} className="4-package" alt="GÓI DOANH NGHIỆP" />
                    </div>
                    <div className="package-item-price-detail">
                    ...
                    <img className="media-object" src={ICON_SHIELD} alt="AMERITEC" />
                    </div>
                    <div className="media-body">
                    <h2 className="sc-title">DOWNLOAD APP</h2>
                    <h3 className="sc-sub-title">TRẢI NGHIỆM AIPS - ỨNG DỤNG BẢO VỆ ĐIỆN THOẠI TỐT NHẤT</h3>
                    </div>
                    </div>
            ...
            <section className="customer-talk">
                <div className="section-heading3">
                    ...
                    <p style={{ color: '#fff' }}>LỰA CHỌN BẢO MẬT TỐT NHẤT CHO ANDROID VÀ IOS</p>
                </div>
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <div className="elsa-feeling-review-item">
                                    ...
                                    <p className="review-item-text">Mobile phishing protection must go beyond email, email is the primary attack vector for phishing on traditional endpoints. Since 80% of emails are read on mobile devices and most mobile users do not always use on VPN for all traffic, this vector is still very dangerous on mobile devices. But mobile also brings a number of new attack vectors existing solutions are powerless to prevent, e.g., personal email, SMS, messaging apps and even malicious apps that masquerade as legitimate apps.</p>
                                    <div className="author-review">
                                        <img src={USER_LOGO} className="author-img" alt="author-img" />
                ...
                <div className="section-heading3 lg-none">
                    ...
                    <p style={{ color: '#fff' }}>Ameritec AIPS - Ứng dụng bảo mật điện thoại di động hàng đầu tại Việt Nam</p>
                </div>
                <div id="carouselExampleControls2" className="carousel slide carousel-fade" data-ride="carousel">
                    <div className="carousel-inner carousel-inner-video">
                        ...
                        <div className="carousel-item active carousel-video">
                            <div className="video">
                                <iframe src="https://www.youtube.com/embed/JhGCnn5qkdI" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
                            </div>
                        </div>
                        <div className="carousel-item carousel-video">
                            <div className="video">
                                <iframe src="https://www.youtube.com/embed/WKDp26gBWx4" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
                            </div>
                        </div>
                        <div className="carousel-item carousel-video">
                            <div className="video">
                                <iframe src="https://www.youtube.com/embed/k4qSUe-wlYk" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container-xl">
                        <div className="top-footer">
                            ...
                            <form action className="info-form">
                                <label htmlFor>🎉 Nhận tin tức mới nhất về An ninh mạng vào hộp thư của bạn</label>
                                <div>
                                    <input type="email" placeholder="Nhập Email Của Bạn" />
                                    <button type="submit" className="ml-4">Gửi</button>
                                </div>
                            </form>
                        </div>
                        <div className="row">
                            <div className="col-md-3 col-sm-6 col-12 info-item">
                                <div className="info">
                                    <div className="header-info">
                                        ...
                                        <p>📍 Address: 2505 S. Great Southwest Pkwy Grand Prairie, TX 75052</p>
                            ...
                            <div className="col-md-3 col-sm-6 col-12 info-item">
                                <div className="header-info">
                                    ...
                                    <p>📍 Địa chỉ: Tầng 25.02 Tòa nhà Viettel số 285 cách mạng tháng 8 , P.12, Q.10, TP. Hồ Chí Minh</p>
                            ...
                            <div className="col-md-3 col-sm-6 col-12 info-item">
                                <div className="header-info">
                                    ...
                                    <p><a href="#">Trung Tâm Hỗ Trợ Khách Hàng</a></p>
                            ...
                            <div className="col-md-3 col-sm-6 col-12 info-item">
                                <div className="header-info">
                                    <h3>Liên Hệ</h3>
                                    <ul>
                                        <li><a href="https://www.facebook.com/ameritecjsc">
                                            <img src={FACE} alt width="50px" />
                                        </a></li>
                                        <li><a href="https://www.youtube.com/channel/UCvxi8TE2txGco_yoU-yVKUw">
                        ...
                        <div className="copy-right">
                            <span>©&nbsp;Bản quyền thuộc về <a href="http://ameritecjsc.com">Ameritec</a>&nbsp; </span>
                        </div>
                    </div>
                </div>
            </section>
