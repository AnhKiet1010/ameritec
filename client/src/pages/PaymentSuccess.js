    ...
    API.successWatched({ trans_id })
      .then((res) => {
        ...
        if (status === 200) {
          ...
          setPrice(i18n.language === "vi" ? res.data.data.trans.amount_vnd.toString() : res.data.data.trans.amount_usd.toString());
        }
        if (status === 400) {
          history.push("/");
        }
      ...
      <div className="flex flex-col p-10 md:p-20">
        <div className="nine wide column">
          ...
          <div className="result__content">
            ...
            <a
              className="ui primary button result__item mb-6"
              href="/login"
            >
        ...
        <div className="seven wide column ">
          <div className="result__order-summary-wrapper">
            ...
            <div className="result__order-item-wrapper result__content--pd">
              ...
              {
                trans.buy_package === '1' && <h4 className="result__order-item__name">{t('Gói Cá Nhân')}</h4>
              }
              {
                trans.uy_package === '2' && <h4 className="result__order-item__name">{t('Gói Khởi Nghiệp')}</h4>
              }
              {
                trans.buy_package === '3' && <h4 className="result__order-item__name">{t('Gói Doanh Nghiệp')} A</h4>
              }
               {
                trans.buy_package === '4' && <h4 className="result__order-item__name">{t('Gói Doanh Nghiệp')} B</h4>
              }
            </div>
            <div className="result__paying-info result__content--pd">
              <div className="result__paying-info-wrapper">
                <span className="result__paying-info__label">{t('Tổng phụ')}</span>
                <span>
                  <span
              ...
              <div className="result__paying-info-wrapper">
                <span className="result__paying-info__label">{t('Tổng cộng')}</span>
                <span>
                  <span
                    className="result__paying-info__value"
                    data-allow-decimal-padding="false"
